      ...
      <div class="lg:col-span-2 reveal-up space-y-6">
        ...
        <div class="pt-4">
          ...
          <div class="flex gap-4">
            <a href="https://github.com/kaguray85" target="_blank" rel="noopener noreferrer" class="social-icon w-10 h-10 glass-card rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-colors">
            ...
            <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" class="social-icon w-10 h-10 glass-card rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-colors">
      ...
      <div class="lg:col-span-3 reveal-right">
        <div class="glass-card p-8 lg:p-10 rounded-2xl">
          ...
          <form id="contact-form" class="space-y-5" novalidate>
            <div>
              <label for="name" class="block text-xs font-mono text-gray-400 mb-2 uppercase tracking-widest">Your Name</label>
              <input id="name" name="name" type="text" placeholder="Muhammad Khaliz" minlength="2" required
            ...
            <div>
              <label for="email" class="block text-xs font-mono text-gray-400 mb-2 uppercase tracking-widest">Email Address</label>
              <input id="email" name="email" type="email" placeholder="hello@example.com" required
                     class="form-input w-full bg-surface-2 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-accent/50 transition-colors text-sm" />
            </div>

            <div>
              <label for="message" class="block text-xs font-mono text-gray-400 mb-2 uppercase tracking-widest">Message</label>
              <textarea id="message" name="message" rows="5" placeholder="Tell me about your project..." minlength="10" maxlength="2000" required
...
async function submitForm(event) {
  ...
  if (message.length > 2000) return showAlert('error', 'Message is too long (max 2000 chars).');
